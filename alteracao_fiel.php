...
<title>Alteração Fiel</title>
</head>
<body>
<center>Alterar Fiel</center>
<br /><br /><br />
<?php
...
<td align="center"><input type="button" value="Voltar" onclick="javascript: location.href='http://localhost:887/sistemadedizimo/consulta_fiel.php';" />
